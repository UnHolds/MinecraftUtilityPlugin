...
public class XPCalculator {
    ...
    public static int expToLevel(int exp) {
        ...
        if (exp <= 351) {
            level = (int) Math.floor(-3 + Math.sqrt(exp + 9.0));
        } else if (exp <= 1623) {
            level = (int) Math.floor(8.1 + 0.1 * Math.sqrt(40 * exp - 7839.0));
        } else {
            level = (int) Math.floor(18.0556 + 0.05555555 * Math.sqrt(72 * exp - 54215.0));
        }
